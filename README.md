...
```go
go get github.com/geekymedic/pingpp-go/pingpp
```

导入后，在调用的时候需要

```go
import (pingpp "github.com/geekymedic/pingpp-go/pingpp")
```
具体使用相应模块的话还需要

```go
import (pingpp "github.com/geekymedic/pingpp-go/pingpp/xxx")
```
